...
Selection.draw = function() {
	...
	Canvas.ctx.strokeRect(Selection.startX, Selection.startY, Selection.endX
			- Selection.startX, Selection.endY - Selection.startY);
};
...
Selection.setEnd = function(x, y) {
	...
	// Bottom left corner
	Selection.endX = x * Grid.size / Grid.actualSize;
	Selection.endY = y * Grid.size / Grid.actualSize;
};